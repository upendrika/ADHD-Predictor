...
if app_mode == 'Home':
    ...
    with col2:
        ...
        st.markdown("""
        - Category <span style="color:red; font-weight:bold;">'Highly Likely'</span>: adhd_total score above 24.
        - Category <span style="color:orange; font-weight:bold;">'Likely'</span>:adhd_total score between 17 and 24.
